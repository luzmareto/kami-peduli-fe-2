<template>
  <header class="flex items-center">
    ...
    <ul class="flex items-center">
      ...
      <li>
        <a class="text-white hover:text-teal-500 text-lg px-4 py-3" href="#">Project</a>
      </li>
      <li>
        <a class="text-white hover:text-teal-500 text-lg px-4 py-3" href="#">Features</a>
      </li>
      <li>
        <a class="text-white hover:text-teal-500 text-lg px-4 py-3" href="#">Success Stories</a>
      </li>
    </ul>
    <!-- Mengubah tampilan ketika login -->
    ...
    <div class="flex ml-auto" v-else>
      <div class="dropdown inline-block relative z-10">
        <button class="bg-white text-gray-700 font-semibold py-4 px-6 rounded inline-flex items-center ">
          <img v-if="$store.state.auth.user.image_url"
...
<style scoped>
  .dropdown:hover .dropdown-menu {
    display: block; /* Tampilkan dropdown menu saat hover */
  }
  .dropdown-menu {
    display: none; /* Sembunyikan dropdown menu secara default */
  }
</style>
